...
_0x0:
	.DB  0x5A,0x45,0x52,0x4F,0x42,0x49,0x54,0x53
	.DB  0x30,0x31,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 0097 DDRC = 0x0F;
	LDI  R30,LOW(15)
	OUT  0x14,R30
; 0000 0098 STEPPER = 0x00;
	LDI  R30,LOW(0)
	OUT  0x15,R30
; 0000 0099 
; 0000 009A lcd_gotoxy(4,0);
	LDI  R30,LOW(4)
	ST   -Y,R30
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 009B lcd_putsf("ZEROBITS01");
	__POINTW2FN _0x0,0
	CALL _lcd_putsf
; 0000 009C 
; 0000 009D while (1)
...
; 0000 00A0         for(step = 0; step < 8; step++){
	__GETWRN 16,17,0
_0x7:
	__CPWRN 16,17,8
	BRGE _0x8
; 0000 00A1             delay_ms(100);
	...
	LDI  R27,0
	CALL _delay_ms
; 0000 00A2             STEPPER = steps[step];
	MOVW R30,R16
	SUBI R30,LOW(-_steps*2)
	SBCI R31,HIGH(-_steps*2)
	LPM  R0,Z
	OUT  0x15,R0
; 0000 00A3         }
	__ADDWRN 16,17,1
