...
// Timer Period: 0.52224 s
// Output Pulse(s):
// OC0 Period: 0.52224 s Width: 0 us
...
// Timer Period: 0.52224 s
// Output Pulse(s):
// OC1A Period: 0.52224 s Width: 0 us// OC1B Period: 0.52224 s Width: 0 us
...
// Timer Period: 0.52224 s
// Output Pulse(s):
// OC2 Period: 0.52224 s Width: 0 us
ASSR=0<<AS2;
            ...
            */               
            ...
            if(adc3/2 > 50){
                ...
                if(j == 0)
                {
                    i++;
                    j = 1;
                    printf("[+] fire detcted!!! %d \r",i);
                    // hc-05 just connect the tx to module rx and ...
                    // we can use rx to for running some commands we should do that
                    // r|l and a digit for controlling
                }
            }else{
                j = 0;
                OCR1A = 0;
